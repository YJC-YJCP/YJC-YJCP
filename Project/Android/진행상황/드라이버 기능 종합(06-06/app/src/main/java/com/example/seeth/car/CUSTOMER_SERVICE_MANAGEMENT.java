...
class CUSTOMER_SERVICE_MANAGEMENT extends ObjectTable implements Serializable,Cloneable{
	...
	public Object clone()
	{
		CUSTOMER_SERVICE_MANAGEMENT CSM = new CUSTOMER_SERVICE_MANAGEMENT();
