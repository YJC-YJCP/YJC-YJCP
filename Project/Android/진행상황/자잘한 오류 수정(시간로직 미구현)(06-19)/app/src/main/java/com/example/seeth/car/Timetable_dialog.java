...
//        mContentView.setText(mContent);
        if(!left.getText().equals(null)){
            AM_text.setText(left.getText().toString());
        }
        if(!right.getText().equals(null)){
            PM_text.setText(right.getText().toString());
        }
...
//            Toast.makeText(getContext(), "ap버튼 클릭", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(getContext(), "왼쪽버튼 클릭", Toast.LENGTH_SHORT).show();
            String a,p;
