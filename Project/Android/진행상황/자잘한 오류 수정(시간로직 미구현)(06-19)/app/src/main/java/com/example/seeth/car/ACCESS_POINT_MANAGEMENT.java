...
class ACCESS_POINT_MANAGEMENT extends ObjectTable implements Serializable,Cloneable{
	...
	private int SEARCH_POSSIBILITY;
	private String CARPOOL_DESCRIPTION;
	private int ACCESS_POINT_TOTALINDEX;

	public int getSEARCH_POSSIBILITY() {
		return SEARCH_POSSIBILITY;
	}
	public void setSEARCH_POSSIBILITY(int sEARCH_POSSIBILITY) {
		SEARCH_POSSIBILITY = sEARCH_POSSIBILITY;
	}
	public String getCARPOOL_DESCRIPTION() {
		return CARPOOL_DESCRIPTION;
	}
	public void setCARPOOL_DESCRIPTION(String cARPOOL_DESCRIPTION) {
		CARPOOL_DESCRIPTION = cARPOOL_DESCRIPTION;
	}
	public int getACCESS_POINT_TOTALINDEX() {
		return ACCESS_POINT_TOTALINDEX;
	}
	public void setACCESS_POINT_TOTALINDEX(int aCCESS_POINT_TOTALINDEX) {
		ACCESS_POINT_TOTALINDEX = aCCESS_POINT_TOTALINDEX;
	}
	...
	public void setSelectOperation(ResultSet rs) {
		...
		try {
			...
			this.setSEARCH_POSSIBILITY(rs.getInt("SEARCH_POSSIBILITY"));
			this.setCARPOOL_DESCRIPTION(rs.getString("CARPOOL_DESCRIPTION"));
			this.setACCESS_POINT_TOTALINDEX(rs.getInt("ACCESS_POINT_TOTALINDEX"));
