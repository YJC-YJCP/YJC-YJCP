...
class CARPOOL_PATH_MANAGEMENT extends ObjectTable implements Serializable,Cloneable {
	...
	private String STARTING_POINT_DESCRIPTION;
	...
	public String getSTARTING_POINT_DESCRIPTION() {
		return STARTING_POINT_DESCRIPTION;
	}

	public void setSTARTING_POINT_DESCRIPTION(String sTARTING_POINT_DESCRIPTION) {
	...
	public void setSelectOperation(ResultSet rs) {
		...
		try{
			...
			this.setSTARTING_POINT_DESCRIPTION(rs.getString("STARTING_POINT_DESCRIPTION"));
			this.setDESTINATION_DESCRIPTION(rs.getString("DESTINATION_DESCRIPTION"));
		} catch (Exception e) {
	...
	public void setARRIVAL_TIME(Time aRRIVAL_TIME) {
		...
		if(aRRIVAL_TIME==null){
			...
			ARRIVAL_TIME=null;
			int hour=aRRIVAL_TIME.getHours();
			int minute = aRRIVAL_TIME.getMinutes();
			ARRIVAL_TIME= new Time(hour,minute,0);
		}
	}
