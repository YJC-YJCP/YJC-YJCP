...
public class passenger_main extends AppCompatActivity{
    ...
    public void select_db_state(){
        ...
        else if(Integer.parseInt(bp.getACCPTANCE_STATE())==2||Integer.parseInt(bp.getACCPTANCE_STATE())==3){
            switchFragment(2);
        }
        sk = null;
    }
    ...
    public void switchFragment(int i) {
        ...
        if (i==0) {
            if(ct.getTIME_FOR_SCHOOL()==null||ct.getTIME_FOR_HOME()==null) {
            ...
            fr = new waiting_magic(0.0,0.0,longitude,latitude,id,position,goback);
        }
        else if(i==2||i==3){
           fr = new progress_magic(id,position,goback);
        }
